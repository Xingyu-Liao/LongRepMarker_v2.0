...
>> baidu cloud drive （https://pan.baidu.com/s/1jXZcgkvHHw_dug8fuKtngQ ， Extraction code：2022）. </br>
...
>> some large datasets (E.g, the genome size >=2Gb or the total size of sequencing data >= 20GB).</b></i></br>
