...
##                                                                      ##
  ...
  $configuration = {
          ...
          'REPEATMASKER_DIR' => {
                                  ...
                                  'required' => 1,
                                  #'value' => ''
                                  #'value' => '/home/LongRepMarker/tools/RepeatMasker'
                                  'value' => '$grandParent/RepeatMasker'
                                   #print $value, "\n";
                                },
          'RMBLAST_DIR' => {
                             ...
                             'required' => 1,
                             #'value' => ''
                             #'value' => '/home/LongRepMarker/tools/rmblast-2.11.0/bin'
                             'value' => '$grandParent/rmblast-2.11.0/bin'
                              #print $value, "\n";
                           },
          'RSCOUT_DIR' => {
          ...
          'TRF_PRGM' => {
                          ...
                          'param_type' => 'program',
                          'required' => 1,
                          'value' => '$grandParent/TRF-master/build/src'
                          #'value' => '/home/LongRepMarker/tools/TRF-master/build/src' 
